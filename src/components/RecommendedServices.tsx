const services = [
  {
    icon: "🎓",
    title: "학생비자 (Tier 4)",
    desc: "영국 대학·어학연수 학생비자 대행. CAS 확인부터 서류 준비, 신청까지 원스톱.",
    price: "₩350,000~",
    tag: "BEST",
  },
  {
    ...
    desc: "영국 취업비자 스폰서십 확인, 서류 작성, 신청 전 과정 대행 서비스.",
    price: "₩500,000~",
    tag: "HOT",
  },
  {
    ...
    desc: "관광, 가족 방문, 단기 비즈니스 등 영국 방문비자 전문 대행.",
    price: "₩250,000~",
    tag: "",
  },
  {
    ...
    desc: "영국 시민권자·영주권자 배우자를 위한 비자 대행. 복잡한 서류도 안심.",
    price: "₩600,000~",
    tag: "NEW",
  },
];
