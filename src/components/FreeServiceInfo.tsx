const services = [
  { n: "01", title: "비자 지원 상담", desc: "무료 비자 대행 대상 여부 확인" },
  { n: "02", title: "CAS 발급 요청 대행", desc: "일부 파트너 대학 CAS 발급 요청 진행" },
  { n: "03", title: "프리세셔널 등록 지원", desc: "입학 전 사전어학 과정 신청 대행" },
  { n: "04", title: "비자 신청 서류 안내", desc: "결핵검사, 재정 증빙 준비 철저 안내" },
  { n: "05", title: "비자 신청서 작성 지원", desc: "개별 확인 후 신청서 작성 및 최종 제출" },
  {
    n: "06",
